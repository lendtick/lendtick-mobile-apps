...
class PaketDataFinishComponent extends Component {
    static navigationOptions = ({navigation}) => ({
        title: "Finish Paket Data",
                ...
                <ScrollView>
                    ...
                    <View style={[Main.container,{marginTop: 15,paddingBottom: 30}]}>
                        ...
                        <View style={{padding: 30, marginBottom: 50, backgroundColor: Variable.backgroundGray}}>
                            <Text style={Typography.heading5}>Pembelian Paket Data Berhasil</Text>
...
export default PaketDataFinishComponent;