...
class ListrikFinishComponent extends Component {
    static navigationOptions = ({navigation}) => ({
        title: "Finish Token Listrik",
                ...
                <ScrollView>
                    ...
                    <View style={[Main.container,{marginTop: 15,paddingBottom: 30}]}>
                        ...
                        <View style={{padding: 30, marginBottom: 50, backgroundColor: Variable.backgroundGray}}>
                            <Text style={Typography.heading5}>Pembelian Token Listrik Berhasil</Text>
...
export default ListrikFinishComponent;