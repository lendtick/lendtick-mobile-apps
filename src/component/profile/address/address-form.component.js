...
import { CartDirective,InputComponent,ButtonComponent,AlertBox } from '../../../directive/index';
...
class AddressFormComponent extends React.Component {
    ...
    onSubmit(data){
        ...
        if(this.state.isUpdate){
            ...
            profileService.putAddress(data).then(res =>{
                this.setState({
                    isSuccess: true,
                    isSubmit: false,
                });
            ...
            // Post Address
            // ================== //
            profileService.postAddress(data).then(res =>{
                this.setState({
                    isSuccess: true,
                    isSubmit: false,
                    address_name: null,
