...
import { CartDirective,FooterButton,ItemProduct } from '../../directive/index';
...
class ProductDetailComponent extends React.Component {
    ...
    constructor(props) {
        ...
        this.state = { 
            entries:[
                {id: "01", title: "coba 1", src:require("../../../assets/product/detail/img01.png"), link:""},
                {id: "02", title: "coba 2", src:require("../../../assets/product/detail/img02.png"), link:""},
                {id: "03", title: "coba 3", src:require("../../../assets/product/detail/img03.png"), link:""},
            ],
            selectedLink: 'produk',
            productsRecomended: [
